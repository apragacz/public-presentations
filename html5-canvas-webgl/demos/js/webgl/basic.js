(function () {
    ...
    window.getGLContext = function (canvas) {
        var gl = null;
        try {
    ...
    window.createShaderProgram = function (gl, vertexShaderCode, fragmentShaderCode) {
    ...
    window.createTriangleVertexPositionBuffer = function (gl, vertices) {
    ...
    window.drawScene = function (gl, shaderProgram, pMatrix, mvMatrix, triangleVertexPositionBuffer) {
